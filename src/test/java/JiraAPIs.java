...
// TODO Auto-generated method stub
       ...
       //relaxedHTTPSValidation() method is used to bypass authentication
       String response=given().relaxedHTTPSValidation().header("Content-Type","application/json")
       .body("{\r\n" +
              "    \"username\": \"asitkumar\",\r\n" +
              "    \"password\": \"apiautomation\"\r\n" +
       ...
       .header("Content-Type","multipart/form-data").multiPart("file",new File("C:\\Users\\000ZZ8744\\Desktop\\to do.txt\\")).when().
